...
!Running configuration last done at: Wed Jul 23 21:11:57 2025
!Time: Wed Jul 23 21:12:29 2025
...
class-map type qos match-any voip-class
  match dscp 46
policy-map type qos voip-priority
  class voip-class
    set cos 5
...
snmp-server user master network-operator auth md5 177C91DC988C6569BCF16BC7CE4EEFBAEF44 priv 054BC1ADC59A2674A0F303A89715AE90C865 localizedV2key
snmp-server user vivaldi network-admin auth md5 52064E3BE2AC4CD7F6960DAB8F9AB9B5E7C7 priv 5300285CC29B28A491F236C0160A0766C9AE localizedV2key
...
interface Ethernet1/42
  description LLDP_32:94_sw-core-stack
  no cdp enable
  switchport mode trunk
  switchport trunk allowed vlan 2,115,132,200
  spanning-tree port type edge trunk
  spanning-tree bpduguard enable
