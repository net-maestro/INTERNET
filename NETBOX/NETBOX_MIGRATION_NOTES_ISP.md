...
10. [Работа с API NetBox: автоматизация ISP](#10-работа-с-API-NetBox:-автоматизация-для-ISP)
...
Ниже — **дополнение к руководству** с практическими примерами работы с **NetBox API**, включая:

- Получение списка коммутаторов
- Автоматическая заливка оборудования
- Создание префиксов и IP-адресов
- Работа с клиентами (Tenants)
- Использование токена аутентификации
- Примеры на Python (с `requests`)

Добавлю это как новый раздел **#10. Работа с API NetBox: автоматизация для ISP**, который логично впишется в ваше руководство.
